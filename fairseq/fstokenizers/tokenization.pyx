...
from .fstokenizers.sentencepiece_proto cimport SentencePieceText, SentencePieceTextSentencePiece
from .fstokenizers.pyrobuf_list cimport *
from .fstokenizers.pyrobuf_util cimport *
SPIECE_UNDERLINE = '▁'
